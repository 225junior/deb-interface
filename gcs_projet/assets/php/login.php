<?php
#accessible seulement a celui qui est connect� si tu es connect�
...
if(isset($_POST['login']))
{
        ...
        if($count > 0)
        ...
        else if($count == 0)
            {
             ...
             <script type="text/javascript">
                alert('Compte inexistant, Veuillez cr�er un compte svp!');
    ...
    ?>
     <script type="text/javascript">
        alert('Connectez Vous pour acceder � la plateforme');
        setTimeout(function(){window.location.href="../../login.html";},100);
     </script>
     <?php
}
