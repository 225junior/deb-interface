...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        <div class="card">
        <div class="card-header">Produit -> Modiffication
        ...
        <div class="card-body">
            ...
            <form method="POST" action="../assets/php/up_produit.php">
                    <!-- name = libelle  -->
               <div class="form-group" >
                ...
                <div class="form-group form-float">
                  ...
                  <!-- name = valider  -->
                <div class="form-group">
                    <button type="submit" name="upproduit" class="btn btn-info px-5 btn-block">Modifier</button>
                </div>
