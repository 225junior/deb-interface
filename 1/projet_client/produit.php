...
<div class="row m-3">
  ...
  <div class="col-3">
    <h4 class="text-left">Produits</h4>  
  </div>
...
<div class="card">
  <div class="card-header">Liste de tous les Produits </div>
    ...
    <table class="table align-items-center table-flush table-borderless">
      <thead>
        <tr>
         ...
         <th width="25%">categorie produit</th>
...
<?php 
                        ...
                        echo "<td><a class='btn btn-info' href='produit-update.php?'>Modifier</a> <a class='btn btn-danger' href='delete/delete_produit.php?id_produit=$row_produit[id_produit]\" onClick=\"return confirm('Voulez-vous vraiment supprimer ce produit')\'>Supprimer</a></td>";
                                                  //echo"<td>  </td>";
                        echo "</tr>";
