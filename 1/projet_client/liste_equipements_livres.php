...
<div class="row m-3">
  ...
  <div class="col-3">
    <h4 class="text-left">Equipements livres</h4>  
  </div>
...
<div class="card">
  <div class="card-header">Liste de tous les equipements livres </div>
                                        ...
                                        while ($row_equiplivre=$statement_equiplivre->fetch()) 
                                            {
                                                ...
                                                echo "<td><a class='btn btn-info'>Modifier</a> <a class='btn btn-danger'>Supprimer</a></td>";
