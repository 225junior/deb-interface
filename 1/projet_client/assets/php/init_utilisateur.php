...
//Indexer le type utilisateur

$query_departmt="SELECT * FROM departement WHERE id_dep=:id_dep ";
$statement_departmt=$pdo->prepare($query_departmt);
$statement_departmt->execute(array(':id_dep'=>$id_dep));
$row_departmt=$statement_departmt->fetch();
?>
