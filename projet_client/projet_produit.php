...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        <div class="card">
        <div class="card-header">ajout des produits
        ...
        <div class="card-body">
           ...
           <form method="POST" action="assets/php/add_projet_produit.php">

                    <!-- name = projets -->
              
               <div class="form-group form-float">
                  <label for="projet">Projets</label>
                    <select class="form-control" required="" name="id_projet">
                       <?php
                                while($row_projet=$statement_projet->fetch())
                                     {
                                        echo "<option value=".$row_projet['id_projet'].">". $row_projet['nom_projet']." </option>";
               ...
               <div class="form-group form-float">
                  <label for="Categorie_produit">Categorie produits</label>
               ...
               <div class="form-group form-float">
                  <label for="Produit">Produits</label>
                    <select class="form-control" required="" name="id_Produit">
                   <?php
                                while($row_Produit=$statement_Produit->fetch())
                                     {
                                       echo "<option value=".$row_Produit['id_Produit'].">". $row_Produit['nom_Produit']." </option>";
              ...
              <!-- name = id_utilisateur -->
                ...
                <div class="form-group form-float">
                  ...
                  <select class="form-control" required="" name="statut_produit" >
                  <option>Livre</option>  
                  <option>Non Livre</option> 
                  </select>
                  </div>

                    <!-- name =  -->
                <div class="form-group">
                    <button type="submit" name="addprojet" class="btn btn-info px-5 btn-block">Valider</button>
                </div>
            </form>
        </div>
        </div>
