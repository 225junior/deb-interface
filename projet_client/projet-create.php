...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        ...
        <div class="card-body">
           ...
           <form method="POST" action="assets/php/add_projet.php">
                    <!-- name =  -->
              
                <div class="form-group" >
                    <label for="input-1">Nom projet</label>
                    <input type="text" name="nom_projet" class="form-control" id="input-1" required placeholder="Entrez le nom projet">
                </div>

                <div class="form-group" >
                    <label for="input-1">Date</label>
                    <input type="Date" name="date_projet" class="form-control" id="input-1" required placeholder="">
                </div>
              ...
              <!-- name = id_utilisateur -->
                ...
                <div class="form-group form-float">
                  <label for="utilisateur"> utilisateur</label>
                                    <select class="form-control" required="" name="id_utilisateur">
                                               <?php
                                                  while($row_utilisateur=$statement_utilisateur->fetch())
                                                    {
                                                        echo "<option value=".$row_utilisateur['id_utilisateur'].">". $row_utilisateur['nom_utilisateur']." ". $row_utilisateur['prenom_utilisateur']." </option>";
              ...
              <select class="form-control" name="id_utilisateur" required="required">
                <option>jfffhgfh</option>

              </select>-->
                <!--<div class="form-group" >
                    <label for="input-1"></label>
                    <input type="text" name="libelle" class="form-control" id="input-1" required placeholder="Entrez le titre"></div>-->

                    </div> 

                    <!-- name =  -->
                <div class="form-group">
                    <button type="submit" name="addprojet" class="btn btn-info px-5 btn-block">Creer</button>
                </div>
            </form>
