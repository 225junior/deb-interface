    ...
    while ($row_projet=$statement_projet->fetch()) 
            {
                                                ...
                                                $statement_utilisateur->execute(array(':id_utilisateur'=>$id_utilisateur));
                                                $row_utilisateur=$statement_utilisateur->fetch();
                        echo "<tr>";
                        echo "<td>
                        <p class='c_name'>".$row_projet['nom_projet']."</p></td>";
                         echo "<td><p class='c_name'>".$row_projet['date_projet']."</p></td>";
                         echo "<td><i class=''></i>".$row_utilisateur['nom_utilisateur']."   ". $row_utilisateur['prenom_utilisateur']."</td>";
                        //echo "<td><p class='c_name'>".$row_projet['nom_utilisateur']."</p></td>";
                        echo "<td><a class='btn btn-info' href='projet-update.php?'>Modifier</a> <a class='btn btn-danger' href='delete/delete_projet.php?id_projet=$row_projet[id_projet]\" onClick=\"return confirm('Voulez-vous vraiment supprimer cet projet ?')\'>Supprimer</a></td>";
                          //echo"<td>  </td>";
                          echo "</tr>";
