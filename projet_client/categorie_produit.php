...
<div class="row m-3">
  ...
  <div class="col-4">
    <h5 class="text-left">Liste des categories produits</h5>
  </div>

  <div class="col-4 offset-4">
    <a class="btn btn-light" href="categorie_produit-create.php">Ajouter une categorie de produit</a>
  </div>
</div>
...
<div class="row">
    ...
    <table class="table align-items-center table-flush table-borderless">
      <thead>
        <tr>
          <th width="70%">Libelle categorie</th>
