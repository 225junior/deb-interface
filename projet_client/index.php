    ...
    <div class="card-content">
        <div class="row row-group m-0">
            ...
            <div class="col-12 col-lg-6 col-xl-6 border-light">
                <div class="card-body">
                  <p class="mb-0 text-white small-font"><a href=liste_equipements_livres.php>Liste des equipements livres</a></p>
                </div>
            </div>
            
            <div class="col-12 col-lg-6 col-xl-6 border-light">
                <div class="card-body">
                  <p class="mb-0 text-white small-font"><a href=liste_equipements_non_livres.php>Liste des equipements non livres</a></p>
                </div>
            </div>
        </div>
    </div>
