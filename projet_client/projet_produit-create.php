...
<div class="row m-3">
  ...
  <div class="col-lg-8">
        <div class="card">
        <div class="card-header">Filiation produit_projet -> Nouvelle
        ...
        <div class="card-body">
           ...
           <form method="POST" action="assets/php/add_projet_produit.php">
               ...
               <div class="form-group form-float">
                  <label for="projet">Produit</label>
                    <select class="form-control" required="" name="id_projet">
                       <?php
              ...
              <!-- name = id_utilisateur -->
                ...
                <div class="form-group">
                    <button type="submit" name="addprojetproduit" class="btn btn-info px-5 btn-block">Valider</button>
                </div>
            </form>
        </div>
        </div>
